...
.ticket-num { display:inline-block; background:#d4edda; color:#155724; font-weight:700; padding:5px 14px; border-radius:20px; font-size:14px; margin:12px 0; }
...
<div class="card">
    ...
    <div class="body">
        <h2>Bonjour,</h2>
        <p>Nous vous informons que votre demande de réouverture a été <strong>acceptée</strong>.</p>

        <div class="ticket-num">Ticket {{ $ticket->numero }} — Réouvert</div>

        <p style="font-size:14px;color:#555;">
            Votre ticket est à nouveau ouvert. Vous pouvez y accéder et continuer la conversation via le lien ci-dessous :
        </p>
