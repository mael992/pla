...
<div class="container py-4" style="max-width:600px">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0"><?php echo e(__('messages.chantier_add_title')); ?></h1>
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('localite')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">
                        💾 <?php echo e(__('messages.btn_create')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\planex\resources\views/chantiers/create.blade.php ENDPATH**/ ?>