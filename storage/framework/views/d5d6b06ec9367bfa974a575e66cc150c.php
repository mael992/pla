...
<div class="page">
    ...
    <div class="logo-block">
        <img src="<?php echo e(public_path('images/Planex.jpg')); ?>" alt="PlanEx">
    </div>
    ...
    <p class="date-line">Date : <?php echo e(now()->format('d/m/Y')); ?></p>
    ...
    <div class="credentials">
        ...
        <p>
            ...
            <span class="cred-value"><?php echo e($user->username); ?></span>
        </p>
        <p>
            <span class="cred-label">Mot de passe provisoire :</span>
            <span class="cred-value">
                <?php echo e($user->temp_password ?? '(voir l\'administrateur)'); ?>
...
<?php /**PATH C:\xampp\htdocs\planex\resources\views/users/courrier.blade.php ENDPATH**/ ?>