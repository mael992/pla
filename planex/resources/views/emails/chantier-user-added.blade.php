...
<div class="card">
    ...
    <div class="body">
        ...
        <div style="background:#f8fafc;border-left:4px solid #e30613;padding:14px 18px;border-radius:4px;margin:16px 0;">
            <div class="info-row"><span>🏗️</span><strong>Chantier :</strong> {{ $chantier->nom }}</div>
            <div class="info-row"><span>📍</span><span>{{ $chantier->localite }}</span></div>
        ...
        <a href="{{ url('/') }}" style="display:inline-block;margin-top:8px;padding:10px 22px;background:#e30613;color:white;text-decoration:none;border-radius:6px;font-size:14px;font-weight:600;">
            Accéder à PlanEx →
        </a>
    </div>
    <div class="footer">
