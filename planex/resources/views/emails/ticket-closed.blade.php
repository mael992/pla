...
<div class="card">
    ...
    <div class="body">
        <h2>Bonjour,</h2>
        <p>Nous vous informons que votre ticket d'incident a été <strong>clôturé</strong>.</p>

        <div class="ticket-num">Ticket {{ $ticket->numero }}</div>

        <div class="info-box">
            Si vous souhaitez contester cette clôture ou demander la réouverture du ticket,
            vous disposez d'un délai de <strong>15 jours</strong>.
        </div>
        ...
        <p style="margin-top:20px;font-size:13px;color:#888;">
            À l'issue de ce délai de 15 jours, le ticket pourra être définitivement supprimé.
        </p>

        <p style="margin-top:16px;font-size:14px;color:#555;">Cordialement,<br><strong>L'équipe PlanEx</strong></p>
    </div>
    <div class="footer">
