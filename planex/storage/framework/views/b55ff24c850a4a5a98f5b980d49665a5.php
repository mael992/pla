        ...
        <div class="card-body p-4">
            <form action="<?php echo e(route('incidents.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-4 pt-3 border-top d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('incidents.index')); ?>" class="btn btn-outline-secondary">Annuler</a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/planex/resources/views/incidents/create.blade.php ENDPATH**/ ?>