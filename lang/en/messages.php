...
return [
    ...
    'user_password'              => 'Password',
    'user_reset_password'        => 'Reset password (temporary)',
    'user_reset_password_help'   => 'A temporary password will be generated automatically. Send it to the user via the 📄 PDF button in the list (one-time use); they will have to change it on first login.',
    'user_reset_password_admin_note' => 'Administrators change their password from "My account".',
    'user_password_reset'        => 'Temporary password reset. Use the 📄 PDF button to send it to the user.',
