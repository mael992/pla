...
return [
    ...
    'user_password'              => 'Password',
    'user_reset_password'        => 'Reimposta la password (provvisoria)',
    'user_reset_password_help'   => "Verrà generata automaticamente una password provvisoria. Trasmettetela all'utente tramite il pulsante 📄 PDF dell'elenco (uso unico); dovrà cambiarla al primo accesso.",
    'user_reset_password_admin_note' => 'Gli amministratori modificano la propria password da « Il mio account ».',
    'user_password_reset'        => "Password provvisoria reimpostata. Usate il pulsante 📄 PDF per trasmetterla all'utente.",
    ...
    'contact_close_account'      => 'Desidero chiudere definitivamente il mio account',
    'contact_close_account_help' => "La sua richiesta sarà gestita dall'amministrazione entro 48-72 ore. Inserisca i dati del suo account qui sotto.",
    'contact_close_username'     => 'Nome utente',
    'contact_close_email'        => "E-mail dell'account",
    'contact_close_subject'      => 'Chiusura account',
